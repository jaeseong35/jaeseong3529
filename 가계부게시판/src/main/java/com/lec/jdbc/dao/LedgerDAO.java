package main.java.com.lec.jdbc.dao;
...
import com.lec.jdbc.mapper.LedgerByAmountRowMapper;
...
//카테고리별 합계
	public List<LedgerByAmountVO> getLedgerList() {
		...
		List<LedgerByAmountVO> ledgerList = jdbcTemplate.query(sql, new LedgerByAmountRowMapper());

		// category 정보 가져오기
		for (LedgerByAmountVO ledger : ledgerList) {
